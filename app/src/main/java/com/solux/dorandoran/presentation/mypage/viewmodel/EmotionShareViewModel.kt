...
class EmotionShareViewModel @Inject constructor() : ViewModel() {
    ...
    private val _emotionShareList = mutableStateListOf(
        EmotionShareEntity(
            ...
            userName = "송이",
            userProfileImage = "",
            likeCount = 5, // 다른 사람들이 좋아요 한 개수
            isLiked = false, // 현재 사용자는 아직 좋아요 안함
            createdAt = ""
        ),
        EmotionShareEntity(
            id = 2,
            ...
            userName = "송이",
            userProfileImage = "",
            likeCount = 19, // 현재 사용자 포함 총 좋아요 개수
            isLiked = true, // 현재 사용자가 이미 좋아요 함
            createdAt = ""
        ),
        EmotionShareEntity(
            id = 3,
        ...
        EmotionShareEntity(
            ...
            userName = "민수",
            userProfileImage = "",
            likeCount = 8, // 현재 사용자 포함 총 좋아요 개수
            isLiked = true, // 현재 사용자가 이미 좋아요 함
            createdAt = ""
        ),
        EmotionShareEntity(
            ...
            userName = "지영",
            userProfileImage = "",
            likeCount = 0, // 아무도 좋아요 안함
            isLiked = false, // 현재 사용자도 좋아요 안함
            createdAt = ""
        )
    )
    ...
    fun toggleLike(emotionId: Long) {
        ...
        if (index >= 0) {
            ...
            val updatedEmotion = currentEmotion.copy(
                isLiked = !currentEmotion.isLiked, // 좋아요 상태 토글
                likeCount = if (currentEmotion.isLiked) {
                    currentEmotion.likeCount - 1 // 좋아요 취소 시 -1
                } else {
                    currentEmotion.likeCount + 1 // 좋아요 시 +1
                }
            )
